...
class DatasetExtractor:
    def __init__(self, context: DatasetContext, has_raman: bool = True):
        self.context = context

    def extract(self):
        train_data, val_data, test_data = self.context.dataset.split(
            self.context.test_size, self.context.seed
        )
